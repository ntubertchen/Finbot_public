...
class NN(object):
	...
	def __init__(self,sess):
		...
		self.path = ["../glove/glove.6B.200d.txt" , "../n_All/train/seq.in" , "../n_All/train/seq.out" , "../n_All/train/int", "../n_All/long.txt","../n_All/currency","../n_All/out"]
	...
	def test(self,sentence):
		batch = self.Data.test_sen2vec(sentence)
